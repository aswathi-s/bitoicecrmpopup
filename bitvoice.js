/**
 * BitVoice Call Center Framework (CCF) - Event Handler
 * 
 * This file provides event handling functionality for BitVoice call center operations,
 * including inbound/outbound call management, agent login handling, and call routing.
 * 
 * @author Anil Mathew
 * @copyright BitVoice Solutions Private Limited
 * @version 1.0.0
 * @created 2024
 * 
 * All rights reserved. This software and associated documentation files (the "Software")
 * are proprietary to BitVoice Solutions Private Limited. Unauthorized copying, modification,
...
async function processIncomingEvent(eventData) {
    ...
    try {
        ...
        const contacts = await Espo.Ajax.getRequest(
            `api/v1/Contact?maxSize=1&where[0][attribute]=phoneNumber&where[0][type]=equals&where[0][value]=${encodePhoneNumberForApi(phoneNumber)}`
        );
        let contactId = null;
